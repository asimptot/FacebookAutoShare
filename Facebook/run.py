...
class Run:
    ...
    def ege_post(self):
        ...
        sozluk = ["egeevarkadasi", "1430596860532102", "254187258119986", "TopluluklarEge", "379934872198429", "egenso",
                  ...
                  "6104626645", "18659112496", "748088955207007", "161523990674375", "226917504020810",
                  "egeuniversitesigezi",
                  "172110019647"]
    ...
    def esme_post(self):
        ...
        esme = ["762951934454642", "1493055600830700", "452448632246858", "1030065057498284", "dervislikoyu",
                "422335515606986",
                "1562201027378354", "2323050764478917", "531806510545262", "1419604838253392", "574000413548546",
                "546914658780031", "1986018184978764", "662521437623764", "sivaslialsat", "796198000551872",
                "2462719980412101",
                "3115960435151650", "2302795416666275", "1751474938464718", "599522303449499", "180888425302580",
                "esmeet",
    ...
    def goztepe_post(self):
        ...
        goztepe = ["330761873609935", "256830128397118", "2730901190498018", "208028558536", "1482691535388761",
                   "1540597852877697",
                   "159424877529948", "332225360477262", "210922582375185", "575389225857771", "1194038040638929",
                   "wwwisoookubra",
                   "229136775939229", "259943855903893", "680538306155255", "416889008451550", "163485201272958",
                   "259820858593897",
                   "453152851683911", "257968525316500", "1119653814739937", "156296471231004", "384831866221969",
                   "202802114364116",
                   "368964550120282", "632261113598528", "278916619179669", "169197057727346", "1743504639157693",
                   "122154371830585",
                   "936992506365153", "goztepecom", "goztepenineskileri", "139935412764982"]
    ...
    def halisaha_post(self):
        ...
        halisaha = ["704021893377737", "2042127099146855", "226545028007", "1545516495775774", "232482893525378",
                    ...
                    "710886928950249",
                    "247446628721533", "109456339122304", "KonyaHaliSahaRakipBul", "1576233845995645",
                    "1471701356239772",
    ...
    def izmir_post(self):
        ...
        izmir = ["izmirelektronikalimsatimtakas", "izmirxizmir", "1499452027011704", "251687191870465",
                 ...
                 "251687191870465", "izmirdecevirme", "2125911384165459", "1674448666166233", "845375905550243",
                 "1827537364172661", "1728725010490278", "5888323829", "305154173262002", "167376063347023", "125445305365",
    ...
    def midyat_post(self):
        ...
        midyat = ["366476150457472", "sevmektir.hedefimiz", "1657378104514078", "alsatikinciel", "midyatemlak",
                  "179094605850162", "1858269431150159", "470681069789097", "6368330842", "midyatlilar",
                  "644401365905547", "1583251101970768", "225415168351155", "1361704113856904", "320887686013399",
                  "313527519293261", "302366493292190", "229982831566921", "1465378513718674", "733019106813950",
                  "581408198549755", "437918623320210", "121644048494414", "973061699487117", "1219335254826260",
                  ...
                  "1713153065572642", "midyat.ogretmenler"]
    ...
    def netherlandspat_post(self):
        ...
        netherlandspat = ["allexpatsinthenetherlands", "internationalexpatamsterdam", "1041306749227527",
                          ...
                          "Best.Jobs.Netherlands", "3391670544390704", "486835584844585",
    ...
    def oyun_tr_post(self):
        ...
        oyun_tr = ["1249974598366070", "androidoyun", "AndroidGelistirme", "GeneralMobileAndroidOne4G",
                   "1018785974868713",
                   "AndroidProgramGelistiricileri", "softwaredevsgroup", "320608442250298", "394535784235625",
                   "unlostv",
                   ...
                   "programlamaogreniyorum", "yazilimgelistir", "1232456353464456", "654147301273036",
                   "1502268376707060",
    ...
    def soke_post(self):
        ...
        soke = ["718233511622533", "2198720647021293", "2614247848875259", "183032711887971", "284487099047799",
                ...
                "447280948738495", "1598433740486562", "1652649881642707", "113022235388425",
    ...
    def torbali_post(self):
        ...
        torbali = ["1674448666166233", "torbalidais", "1674152716182011", "TRMEHMET", "3815981261797816", "tobedak",
                   "1260348790815554", "2153944177989877", "1719536631616508", "531570480830339", "815312195557528",
                   "1138779186487991", "992472454146407", "160202221998957", "461181397343488", "652045991632541",
                   "194760451278928", "1581787365415048", "281538418715072", "1232530130137892", "827540141115373",
...
r = Run()
r.setup()
array = [r.alasehir_post, r.ayrancilar_post, r.ege_post, r.esme_post, r.goztepe_post, r.halisaha_post, r.izmir_post,
