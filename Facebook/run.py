...
class Run:
    ...
    def goztepe_post(self):
        ...
        goztepe = ["256830128397118", "2730901190498018", "208028558536",
                   ...
                   "156296471231004", "384831866221969", "202802114364116", "632261113598528",
    ...
    def halisaha_post(self):
        ...
        halisaha = ["704021893377737", "2042127099146855", "226545028007", "1545516495775774", "232482893525378",
                    ...
                    "710886928950249", "247446628721533", "109456339122304", "KonyaHaliSahaRakipBul",
    ...
    def kilkenny_post(self):
        ...
        kilkenny = ["1430412867205426", "2825610674352955", "teqsportskilkenny", "631488383595071", "140111069525242",
                    "1587632794804215", "2140959319539978"]
    ...
    def manavgat_post(self):
        ...
        manavgat = ["152068948488893", "1235365273171718", "1235437996536777", "945037175514343", "369677536786148",
    ...
    def oyun_en_post(self):
        ...
        oyun_en = ["227842967426189", "appandroiddeveloper", "2061280740824150", "3288987951179541", "1507491152850856",
                   ...
                   "2205727453048193", "mobileappdevelopments", "519011588455568", "mobiloids",
    ...
    def oyun_tr_post(self):
        ...
        oyun_tr = ["1249974598366070", "androidoyun", "AndroidGelistirme", "1502268376707060", "219888054757307",
                   "AndroidProgramGelistiricileri", "softwaredevsgroup", "programlamaogreniyorum", "1511527392393141",
                   "unlostv", "1028228647188038", "MobilGelistiriciler", "oyuncununbilgisayari", "oyungelistiriciler",
                   "btogtoplulugu", "1725332541112353", "togog"]
